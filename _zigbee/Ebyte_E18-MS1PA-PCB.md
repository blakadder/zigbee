...
To be able to use it as a coordinator you need to [flash](/flashing_ccloader.md) the **CC2530_CC2592_xx** [Z-Stack-firmware](https://github.com/Koenkk/Z-Stack-firmware/).
