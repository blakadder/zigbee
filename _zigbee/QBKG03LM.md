...
model: QBKG03LM  
vendor: Xiaomi
title: Aqara double key wired wall switch without neutral wire. Doesn't work as a router and doesn't support power meter
category:
functions:  release/hold, on/off, temperature
